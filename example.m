...
cell_map = sparse(L,M);
cell_map(1,1) = 10; % Number of cells in layer 1, source 1
cell_map(1,2) = 15; % Number of cells in layer 1, source 2
cell_map(1,3) = 20; % Number of cells in layer 1, source 3
cell_map(2,1) = 5;
cell_map(2,2) = 6;
cell_map(2,3) = 7;
cell_map(3,2) = 10;
